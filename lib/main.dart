...
import 'package:proseekr/FileUploadTest.dart';
//import 'signin_up.dart';
enum SelectedActor { JobProvider, JobSeeker }
void main() => runApp(FileUploadTest());
//
...
//      home: FileTestUpload(title: 'Home Page'),
//    );
//  }
//}
//
...
//                            Navigator.push(
//                              context,
//                              MaterialPageRoute(builder: (context) => psSignupin()),
//                            );
//
//                          },
//                        ));

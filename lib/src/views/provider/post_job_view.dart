                ...
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        prefixIcon: new Icon(Icons.work, color: Colors.white),
                        contentPadding:
                            EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                        hintText: AppTranslations.of(context).text("job_title"),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        contentPadding:
                            EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                        hintText: AppTranslations.of(context).text("long_desc"),
                        hintStyle: TextStyle(color: Colors.grey),
                        enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(style: BorderStyle.none),
                            borderRadius: BorderRadius.circular(4.0))),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        contentPadding:
                            EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                        hintText: AppTranslations.of(context).text("salary"),
                        hintStyle: TextStyle(color: Colors.grey),
                        enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(style: BorderStyle.none),
                            borderRadius: BorderRadius.circular(4.0))),
                    ...
                    child: IgnorePointer(
                      child: new TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            fillColor: Colors.black,
                            prefixIcon:
                                new Icon(Icons.date_range, color: Colors.white),
                            contentPadding:
                                EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                            hintText: "Application Start-Date",
                            labelText: startSelected == null
                                ? "Application Start-Date"
                                : (startSelected.toString().split(" "))[0],
                            labelStyle:
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        contentPadding:
                            EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                        hintText: AppTranslations.of(context).text("location"),
                        hintStyle: TextStyle(color: Colors.grey),
                        enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(style: BorderStyle.none),
                            borderRadius: BorderRadius.circular(4.0))),
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                      ...
                      hint: Text('Experience(yrs)',
                          style: TextStyle(
                              fontSize: 18)), // Not necessary for Option 1

...
import 'job_provider/provider_feed.dart';
...
class _UserLoginState extends State<UserLogin> {
  ...
  Future<void> validate(String username, String password) async {
    print("actor" + widget.actor.toString());
    print("globals" + globals.SelectedActor.JobProvider.toString());
    if (widget.actor.toString() == 'JobProvider')
      actor = 'Provider';
    else
      actor = 'Seeker';
    print("log in page" + actor);
